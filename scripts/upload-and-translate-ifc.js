// Upload a local IFC file to APS OSS, then translate it to SVF2.
// IFC IfcSpace elements are included automatically — no roomsAndSpaces flag needed.
//
// Usage: node scripts/upload-and-translate-ifc.js
//
...
// ── 設定區 ──────────────────────────────────────────────────────────────────
const LOCAL_FILE  = path.join(__dirname, '..', '土研2023.ifc');
const BUCKET_KEY  = 'ntucae-soil-2023';   // 全小寫、英數字+連字號，3~128字元
const OBJECT_NAME = '土研2023.ifc';
// ────────────────────────────────────────────────────────────────────────────
